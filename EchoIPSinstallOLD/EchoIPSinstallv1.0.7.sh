...
CRON_HOUR=$((RANDOM % 24)) # T set manually edit crontab -l
...
# Step 1: Get user input for IP address and other variables
...
# Step 2: Create swap file to ensure ample resources
...
# Step 7: Enable Apache2 to start on boot
...
# Step : Ensure prerequisites are installed for PulledPork
